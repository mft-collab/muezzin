  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--app-bg)] p-6">
      <motion.div 
        ...
        className="max-w-md w-full spatial-glass rounded-[32px] shadow-2xl p-10 text-center border border-[var(--glass-border)]"
      >
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={logout}
            className="w-full h-14 bg-[var(--text-primary)]/5 text-[var(--text-primary)] rounded-2xl font-medium hover:bg-[var(--text-primary)]/10 transition-all active:scale-95"
          >
            BAŞKA HESAP KULLAN
          </button>
        </div>
