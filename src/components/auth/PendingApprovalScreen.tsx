  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[var(--app-bg)] p-6 selection:bg-blue-900 selection:text-blue-100">
      <motion.div 
        ...
        className="spatial-glass backdrop-blur-2xl p-10 rounded-[40px] shadow-2xl max-w-md w-full text-center border border-[var(--glass-border)]"
      >
        ...
        <button 
          onClick={logout} 
          className="w-full h-12 text-[var(--text-secondary)] font-medium hover:text-red-500 transition-colors uppercase text-[10px] tracking-widest"
        >
