...
export function LoginScreen({ login, isLoginInProgress }: LoginScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[var(--app-bg)] p-6 relative overflow-hidden transition-colors duration-1000">
      ...
      >
        ...
        >
          <div className="w-28 h-28 bg-[var(--text-primary)]/[0.03] backdrop-blur-2xl rounded-[36px] flex items-center justify-center mx-auto shadow-2xl ring-1 ring-[var(--glass-border)] relative group/logo">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-12">
             <div className="px-4 py-1.5 rounded-full bg-[var(--app-bg)]/80 backdrop-blur-md border border-[var(--glass-border)] flex items-center gap-2 shadow-xl">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_var(--status-success)]" />
                <span className="text-[7px] font-bold tracking-[0.2em] uppercase text-[var(--text-secondary)]">SİSTEM ÇEVRİMİÇİ</span>
             </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-[var(--text-secondary)]/40 mb-14 font-bold tracking-[0.4em] uppercase text-[9px]">
          ...
          >
            ...
            {isLoginInProgress ? (
              <div className="flex items-center gap-4">
                 ...
                 <span className="text-[10px] tracking-[0.4em] font-bold uppercase">Kimlik Doğrulanıyor...</span>
              </div>
            ) : (
              <>
                ...
                <span className="text-[10px] tracking-[0.4em] font-bold uppercase">Google ile Giriş Yap</span>
              </>
            )}
          </motion.button>

          <p className="text-[9px] text-[var(--text-secondary)]/30 font-medium uppercase tracking-[0.3em] px-4">
        ...
        >
          <div className="flex items-center justify-center gap-6 mb-4">
             ...
             <span className="text-[8px] font-bold text-[var(--text-secondary)]/15 uppercase tracking-[0.2em]">T.C. DİYANET İŞLERİ BAŞKANLIĞI</span>
      ...
      <div className="fixed bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-10 opacity-10">
         <span className="text-[8px] tracking-[0.5em] font-bold uppercase">HİZMET KOORDİNASYON SİSTEMİ v2.0</span>
      </div>
    </div>
  );
}
