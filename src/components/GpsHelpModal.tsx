...
export function GpsHelpModal({ isOpen, onClose, onRetry }: GpsHelpModalProps) {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
    ...
    >
      <div className="flex flex-col items-center text-center py-2">
        ...
        <p className="text-base sm:text-lg font-light text-[var(--text-primary)] leading-normal mb-6">
          Konum erişimi tarayıcı veya cihaz ayarlarından engellenmiş.
        </p>

        {/* Browser Mock Address Bar visual guide */}
