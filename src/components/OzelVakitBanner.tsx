  ...
  return (
    <div className="flex flex-col gap-1.5 mt-2.5 pt-2.5 border-t border-current/[0.06]">
      <div className="flex justify-between items-center">
        <span className="text-[8px] font-bold uppercase tracking-widest opacity-35">Kalan Süre</span>
        <span className="text-[9px] font-mono font-bold opacity-60">{kalanMetin}</span>
      </div>
        ...
        >
          ...
          <div className="relative z-10 p-3.5 sm:p-4">
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              {/* Alt başlık badge */}
              <span className={`text-[7px] font-black uppercase tracking-[0.15em] px-2 py-0.5 rounded-full border border-current/15 ${style.sub} flex-shrink-0 mt-0.5`}>
                {durum.altBaslik}
              </span>
            </div>

            {/* Açıklama */}
            <p className={`text-[10px] sm:text-[11px] leading-relaxed mt-2 font-medium ${style.body}`}>
              {durum.aciklama}
            </p>
            ...
            {durum.arapca && (
              <div className="mt-3.5 p-3 rounded-2xl bg-[var(--text-primary)]/[0.02] border border-[var(--glass-border)]">
                ...
                {durum.transkript && (
                  <p className="text-[9px] sm:text-[10px] font-medium mt-1.5 text-[var(--text-secondary)] opacity-75">
                    {durum.transkript}
                  </p>
                )}
              </div>
