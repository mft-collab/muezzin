...
export function LiveClock({ compact, className }: LiveClockProps = {}) {
 ...
 <span className="text-[var(--text-primary)] font-medium text-[11px] uppercase tracking-wide">SAAT</span>
 </div>
 <span className="text-[var(--text-secondary)]/70 text-[11px] uppercase tracking-[0.1em] font-mono tabular-nums">
 {formattedTime}
 </span>
 </div>
 );
