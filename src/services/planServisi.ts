...
export async function haftalikPlanOlustur(haftaId: string): Promise<void> {
 ...
 try {
 // 1. Personel Çekme (yalnızca müezzin rolü planlanır)
 ...
 throw new Error('Planlama için en az 2 aktif müezzin gereklidir.');
 }
 ...
 eskiBildirimler.docs.forEach((bildirimDoc) => {
 ...
 // Günlük tek asil + tek yedek belirlenir ve günün tüm vakitlerine uygulanır.
