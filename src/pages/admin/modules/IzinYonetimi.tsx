...
export default function IzinYonetimi() {
 ...
 <p className="authority-title !text-[11px] opacity-20 tracking-wide uppercase">Talep Verileri Senkronize Ediliyor</p>
 </div>
 </div>
 );
 ...
 <p className="authority-title !text-[11px] opacity-55 uppercase tracking-wide break-all whitespace-normal w-full max-w-full text-center select-all">{error}</p>
 </div>
 );
 ...
 <p className="authority-title !text-[11px] opacity-40 font-medium tracking-wide">PERSONEL İSTİRAHAT VE GÖREV MUAFİYETLERİ</p>
 </div>
 ...
 className={`px-5 py-3 rounded-xl text-[11px] font-bold uppercase tracking-wide transition-all duration-500 shrink-0 ${
 filter === btn.id 
 ...
 exit={{ opacity: 0, y: -8 }}
 className="spatial-glass !bg-amber-500/10 border-amber-500/30 p-4 flex items-center gap-3 text-amber-500 text-[11px] font-bold uppercase tracking-wide shadow-[var(--spatial-shadow)] rounded-2xl"
 >
 ...
 className="spatial-glass p-12 sm:p-16 rounded-3xl text-center flex flex-col items-center max-w-2xl mx-auto border-dashed border-[var(--text-primary)]/10"
 >
 <Calendar className="text-[var(--text-secondary)] mb-8" size={60} strokeWidth={1} />
 <p className="authority-title !text-[11px] opacity-45 uppercase tracking-wide">HİÇBİR İZİN TALEBİ KAYDI BULUNAMADI</p>
 </motion.div>
 ...
 className={`group spatial-glass p-4 sm:p-6 transition-all duration-700 relative overflow-hidden flex flex-col lg:flex-row lg:items-center gap-4 sm:gap-6 lg:gap-8 border border-[var(--glass-border)] !rounded-[20px] sm:!rounded-[32px] ${
 ...
 <span className={`text-[11px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-md border border-[var(--text-primary)]/5 ${
 ...
 <span className="authority-title !text-[11px] opacity-35 uppercase tracking-wide mb-1">BAŞLANGIÇ</span>
 ...
 <div className="flex flex-col">
 <span className="authority-title !text-[11px] opacity-35 uppercase tracking-wide mb-1">BİTİŞ</span>
 ...
 <div className={`px-4 sm:px-6 py-2 rounded-full text-[11px] font-bold uppercase tracking-wide border shadow-sm ${
 izin.durum === 'onaylandi' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-rose-500/10 text-rose-500 border-rose-500/20'
 }`}>
