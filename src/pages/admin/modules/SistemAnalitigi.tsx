    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <motion.div
          ...
          className="lg:col-span-12 spatial-glass p-10 sm:p-12 flex flex-col justify-between min-h-[420px] relative overflow-hidden group shadow-[var(--spatial-shadow)] border border-[var(--text-primary)]/5"
        >
          {/* Living Glow */}
