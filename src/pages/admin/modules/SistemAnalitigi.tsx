...
export default function SistemAnalitigi({ onInceleClick }: { onInceleClick?: () => void }) {
 ...
 <span className="text-3xl text-[var(--dynamic-aura,var(--aura-indigo))]/40 font-light italic leading-none">pts</span>
 <span className="authority-title !text-[7px] text-emerald-500 mt-2 font-bold tracking-wide uppercase">STABİL</span>
 </div>
 </div>
 </div>
 </div>
 ...
 data.value >= 95 ? 'bg-gradient-to-t from-[var(--dynamic-aura,var(--aura-indigo))]/50 via-[var(--dynamic-aura,var(--aura-indigo))]/10 to-transparent' :
 ...
 data.value >= 95 ? 'bg-[var(--dynamic-aura,var(--aura-indigo))] text-[var(--dynamic-aura,var(--aura-indigo))]' :
