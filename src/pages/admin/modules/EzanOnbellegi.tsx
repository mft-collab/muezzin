   ...
   <AnimatePresence mode="wait">
    {uiMessage && (
     ...
     >
      ...
      <p className="text-[12px] font-semibold tracking-wide">{uiMessage.text}</p>
     </motion.div>
    )}
   </AnimatePresence>
    ...
    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5 mb-6">
     <div className="flex items-center gap-4">
      ...
      <div>
       ...
       <p className="text-[12px] text-[var(--text-secondary)]/80">
       ...
       {onbellekler.length === 0 ? (
        ...
        onbellekler.map((o, idx) => (
         ...
         >
          ...
          <td className="px-6 py-4">
           <span className="text-[12px] font-medium text-[var(--text-secondary)]">{formatCacheDate(o.guncellenmeTarihi)}</span>
          </td>
