    ...
    <div className="w-full flex flex-col gap-12">
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <h1 className="text-3xl lg:text-5xl font-light text-[var(--text-primary)] tracking-tight leading-none max-w-2xl group-hover:font-medium transition-all duration-1000">
            Yönetim <span className="text-indigo-500 italic">Senkronize</span> ve <span className="font-normal group-hover:font-bold transition-all duration-1000">Aktif.</span>
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <motion.div
          ...
          className="col-span-1 md:col-span-7 spatial-glass p-8 relative overflow-hidden group min-h-[300px] flex flex-col justify-between cursor-pointer shimmer-trigger"
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
               ...
               <span className="authority-title !text-[8px] opacity-40 font-medium tracking-[0.3em] group-hover:font-bold transition-all duration-700">OPERASYONEL KAPASİTE</span>
            </div>
          ...
          <div className="relative z-10 flex items-center gap-8 mt-6">
            <div className="flex -space-x-4">
              {Array.from({ length: Math.min(muezzinlerSayisi, 4) }).map((_, i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-[var(--app-bg)] bg-[var(--surface-medium)] flex items-center justify-center text-[10px] font-bold shadow-xl relative overflow-hidden backdrop-blur-md">
                  ...
                  {/* Presence Indicator */}
                  <div className="absolute bottom-1 right-1 w-2 h-2 rounded-full bg-emerald-500 border border-[var(--app-bg)] z-20 shadow-[0_0_8px_rgba(16,185,129,0.4)]" />
                </div>
              ))}
              {muezzinlerSayisi > 4 && (
                <div className="w-10 h-10 rounded-full border-2 border-[var(--app-bg)] bg-[var(--text-primary)] text-[var(--app-bg)] flex items-center justify-center text-[10px] font-bold shadow-xl relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent" />
                  +{muezzinlerSayisi - 4}
                </div>
              )}
            </div>
            <p className="authority-title !text-[8px] opacity-30 font-medium tracking-[0.2em]">
              {muezzinlerSayisi} AKTİF PERSONEL SENKRONİZE.
            </p>
          </div>
        </motion.div>
        ...
        <div className="col-span-1 md:col-span-5 flex flex-col gap-8">
          ...
          >
            ...
            <div className="flex items-center justify-between relative z-10">
              ...
              <div className="text-right">
                ...
                <span className="authority-title !text-[7px] opacity-40 mt-2 font-medium tracking-[0.2em]">KRİZ ALARMLARI</span>
              </div>
            </div>
            {cozulmamisSayisi > 0 && (
              <div className="mt-4 pt-4 border-t border-rose-500/10 relative z-10">
                <p className="text-[8px] font-bold text-rose-400 uppercase tracking-[0.2em] truncate">
          ...
          <div className="flex gap-8 flex-1">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <span className="authority-title !text-[7px] opacity-40 mt-2 font-medium tracking-[0.2em]">BEKLEYEN İZİN</span>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-white/5">
                <p className="text-[7px] font-bold text-amber-500/60 uppercase tracking-[0.3em]">AKTİF TALEPLER</p>
              </div>
            </motion.div>
            ...
            >
              <div className="kinetic-sheen" />
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-2xl bg-indigo-500/10 text-indigo-500 border border-indigo-500/20 shadow-lg flex items-center justify-center">
                ...
                <div className="text-right">
                  ...
                  <span className="authority-title !text-[7px] opacity-40 mt-2 font-medium tracking-[0.2em]">DUYURU</span>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-white/5">
                <p className="text-[7px] font-bold text-indigo-400/60 uppercase tracking-[0.3em]">MESAJ YAYINLA</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-between px-4">
          <div className="flex items-center gap-4">
             <div className="w-1 h-3 bg-indigo-500 rounded-full shadow-[0_0_10px_rgb(99,102,241)]" />
             <h2 className="text-xl font-light tracking-tight text-[var(--text-primary)] uppercase tracking-[0.1em]">Canlı Akış</h2>
          </div>
          <span className="authority-title !text-[8px] !text-indigo-400 cursor-pointer hover:text-[var(--text-primary)] transition-all flex items-center gap-2 group tracking-[0.3em] font-medium">
          ...
          <AnimatePresence>
            {combinedOperations.length > 0 ? (
              combinedOperations.map((record, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`spatial-glass p-5 cursor-pointer group transition-all duration-500 relative overflow-hidden ${isExpanded ? 'spatial-glass-elevated border-indigo-500/30' : 'hover:bg-white/[0.02]'}`}
                  >
                    {/* Item Sheen */}
                    ...
                    <motion.div layout className="flex items-center justify-between relative z-10">
                      ...
                      <div className="flex items-center gap-6">
                        <div className={`flex items-center gap-3 px-4 py-1.5 rounded-full border shadow-sm transition-all duration-500 ${
                           ...
                           <span className={`authority-title !text-[6px] relative z-10 transition-all duration-700 font-bold tracking-[0.25em] ${isExpanded ? 'opacity-100 font-black' : 'opacity-30 font-medium group-hover:font-bold'} ${
                        ...
                        >
                          <div className="pt-10 pb-4 grid grid-cols-2 lg:grid-cols-4 gap-10">
                             <div className="flex flex-col gap-3">
                               <span className="authority-title !text-[7px] opacity-30 tracking-[0.2em]">KAYIT KİMLİĞİ</span>
                               <span className="text-[var(--text-primary)] font-mono text-xs tracking-widest opacity-80">#{record.id.substring(0, 10).toUpperCase()}</span>
                             </div>
                             <div className="flex flex-col gap-3">
                               <span className="authority-title !text-[7px] opacity-30 tracking-[0.2em]">KATEGORİZASYON</span>
                               <span className={`text-xs font-medium uppercase tracking-[0.1em] ${record.type === 'alarm' ? 'text-rose-500' : 'text-indigo-400'}`}>
                                 ...
                                 {record.type === 'izin' && record.status === 'pending' ? (
                                   <>
                                     <motion.button 
                                       ...
                                       className="px-6 py-2.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-500 text-[9px] uppercase tracking-[0.2em] font-bold flex items-center gap-3 shadow-lg"
                                     >
                                     ...
                                     <motion.button 
                                       ...
                                       className="px-6 py-2.5 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-500 text-[9px] uppercase tracking-[0.2em] font-bold flex items-center gap-3 shadow-lg"
                                     >
                                   ...
                                   <motion.button 
                                     ...
                                     className="px-6 py-2.5 rounded-2xl bg-white/5 border border-white/10 text-[var(--text-primary)] text-[9px] uppercase tracking-[0.2em] font-bold shadow-lg"
                                   >
                                     DETAYLARI İNCELE
                                   </motion.button>
                                 )}
              ...
              <div className="spatial-glass p-16 text-center flex flex-col items-center gap-4 relative overflow-hidden">
                ...
                <p className="authority-title !text-[8px] opacity-20 tracking-[0.4em]">ŞU AN AKTİF BİR OPERASYONEL KAYIT BULUNMUYOR</p>
              </div>
            )}
          </AnimatePresence>
        </div>
